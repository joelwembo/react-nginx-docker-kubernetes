...
// const Home : React.FunctionComponent<MessageProps> = ({ title }) => {

//     return (
//         <>
//            <div g-sidenav-show   bg-gray-100>
...
//         <span className="ms-1 font-weight-bold">Finengine.io</span>
//       </a>
//     </div>
...
//                 <div className="carousel-item h-100 active" style={ sectionStyle }  >
...
//                   </div>
//                 </div>
//                 <div className="carousel-item h-100" style={ sectionStyleb }>
//                   <div className="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
//                     <div className="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
...
//                   </div>
//                 </div>
//                 <div className="carousel-item h-100" style={ sectionStylec }>
//                   <div className="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
//                     <div className="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
